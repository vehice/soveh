...
urlpatterns = [
    ...
    url(r'^template-reception/(?P<id>\d+)/(?P<userId>\d+)$', views.template_reception, name='template_reception'),
    url(r'^download-reception/(?P<id>\d+)$', views.download_reception, name='download_reception'),
